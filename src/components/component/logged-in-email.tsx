          ...
          <div className="grid gap-4">
              ...
              <CardHeader className="flex flex-col gap-2">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-base font-bold">
                    Welcome to Acme University Mail
                  </CardTitle>
                </div>
                <CardDescription>
                  You have 3 unread messages. Click here to read them.
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  You have 2 upcoming classes today
                </CardDescription>
              </CardHeader>
                  ...
                  <div className="py-3 border-t last:border-b">
                    <div className="flex items-center gap-4">
                      <div className="flex-1">
                        ...
                        <div>
                          Write a 1000-word essay on the effects of global
                          warming
                        </div>
                      </div>
                      <div className="flex flex-col items-end">
                  ...
                  <div className="py-3 border-t last:border-b">
                    <div className="flex items-center gap-4">
                      <div className="flex-1">
                        ...
                        <div>
                          Write a report on the recent chemistry experiment
                        </div>
                      </div>
                      <div className="flex flex-col items-end">
                        <time className="text-sm font-medium">
